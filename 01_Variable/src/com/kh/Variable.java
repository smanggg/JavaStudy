...
public class Variable {
	...
	public static void declareVariable() {
		 ...
		 * - 변수명 : 변수의 이름을 부여하는 부분 (의미있게 작성해주자!)
		 * ***
		 * 명명 규칙
		 *  [1] 카멜케이스 : 소문자로 시작하고, 다른 단어가 붙을 경우 첫글자를 대문자로 시작
		 *  	- 상수 : 스네이크케이스 (SNAKE_CASE). 모두 대문자로 작성하고 다른 단어는 _(언너바)로 구분
