	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			case 2:
				...
				//			--> 없으면 "아이디가 존재하지 않습니다."
				//			[2] Map에 아이디에 해당하는 비밀번호와 입력된 비밀번호가 일치하는지 확인
				//			-> 일치하면 "로그인 성공" --> 일치하지 않으면 "비밀번호가 잘못됐습니다."
				System.out.print("아이디 입력 : ");
				String id2 = sc.nextLine();
				
				if (map.containsKey(id2)) {
					// Map에 입력된 아이디가 키값에 존재하는 경우
			...
			case 3:
				// 정보 수정
				// 아이디를 입력받아 Map에 존재하는 경우, 새로운 비밀번호를 입력받아 수정
