...
public class Run {
	...
	public static void main(String[] args) {
		...
		// => 저장 순서 유지x, 인덱스x, 중복된 데이터 저장 불가
		
		// * String 클래스에는 hashCode() 가 오버라이딩 되어 있음
		// => 실제 담신 문자열을 가지고 10진수의 형태로 반환
		
		// * String 클래스에 equals() 메소드도 오버라이딩 되어 있음
		// => 실제 담긴 문자열에 값을 비교하여 일치하면 true, 그렇지 않으면 false
		...
		//  * ArrayList 에 저장하는 방법 1) ArrayList 생성 후 aadAll 메소드 사용
