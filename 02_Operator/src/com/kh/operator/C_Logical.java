...
public class C_Logical {
	 ...
	 *  _ || 연산자 : 왼쪽(A) 조건이 true 라면 오른쪽(B) 연산이 수행되지 않음!     
	 */
	...
	public static void method1() {
		...
		System.out.println("입력받은 값이 1~10 사이의 값이 벗어나는가? " + result2);
		
	}

	public static void method2() {
		// 입력받은 문자가 소문자인지 확인하는 코드 작성
		Scanner sc = new Scanner(System.in);
		...
		boolean isSmall = chAlpha >= 'a' && chAlpha <= 'z'; // 'a' : 97 --> chAlpha = 'A'
						// 65 >= 97
		System.out.printf("%c 은 소문자인가? %b\n", chAlpha,isSmall);
		
		char chAlpha1 = alpha.charAt(0);
		
		boolean isBig = chAlpha1 >= 'A' && chAlpha1 <= 'Z';
		System.out.printf("%c 은 대문자인가? %b", chAlpha1,isBig);
